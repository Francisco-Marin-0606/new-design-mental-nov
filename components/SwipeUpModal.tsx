...
const styles = StyleSheet.create({
  ...
  closeButton: { position: 'absolute', top: 40, right: 44, width: 40, height: 40, borderRadius: 20, backgroundColor: 'rgba(0, 0, 0, 0.2)', justifyContent: 'center', alignItems: 'center', zIndex: 10 },
